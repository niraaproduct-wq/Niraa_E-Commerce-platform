  ...
  return (
    <>
      ...
      <main className="container page">
        ...
        @media (min-width: 900px) { .home-grid { grid-template-columns: 1fr 460px; align-items: start; } }
        ...
        .hero-image-overlay {
          position: absolute;
          inset: 0;
          background: linear-gradient(to top, rgba(6,32,25,0.7), transparent);
          display: flex;
          flex-direction: column;
          justify-content: flex-end;
          padding: 32px;
          ...
          {mainCombo ? (
            <div className="hero-combo-card" style={{ minHeight: 460, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '24px', background: 'linear-gradient(135deg, #062019 0%, #0f362e 100%)' }}>
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                {mainCombo.comboHighlights && (
                  <div style={{ background: 'rgba(74,222,128,0.15)', border: '1px solid rgba(74,222,128,0.4)', borderRadius: 10, padding: '8px 14px', marginBottom: 14, fontSize: '0.8rem', color: '#4ade80', fontWeight: 700, display: 'inline-block' }}>
                     {mainCombo.comboHighlights}
                  </div>
                )}
                ...
                <div style={{ display: 'flex', gap: 14, borderTop: '1px solid rgba(255,255,255,0.15)', paddingTop: 18, alignItems: 'center' }}>
                  <div style={{ flex: 1 }}>
                     ...
                     <div style={{ fontSize: '0.9rem', color: '#fff', fontWeight: 600, lineHeight: 1.3 }}>Scientifically Formulated.<br/>Eco-Friendly.</div>
                  </div>
                  <div style={{ display: 'flex', gap: 8 }}>
                     {[
                       ...
                       <div key={i} style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.15)', padding: '8px 12px', borderRadius: 12, textAlign: 'center', minWidth: 64 }}>
                          <div style={{ color: '#fff', fontWeight: 900, fontSize: '0.95rem' }}>{s.v}</div>
                          <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.65rem', fontWeight: 700, textTransform: 'uppercase' }}>{s.l}</div>
                       </div>
                     ))}
                  </div>
                </div>
            ...
            <div className="hero-image-container">
              ...
              <div className="hero-image-overlay">
                <div style={{ color: '#fff', marginBottom: 8 }}>
                   <div style={{ fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', color: '#4ade80', letterSpacing: '0.05em', marginBottom: 4 }}>The NIRAA Promise</div>
                   <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.8rem', margin: 0, fontWeight: 900 }}>Scientifically Formulated.<br/>Eco-Friendly.</h2>
                </div>
                ...
                <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
                   {[
                     ...
                     <div key={i} style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.2)', padding: '10px 16px', borderRadius: 16, textAlign: 'center' }}>
                        <div style={{ color: '#fff', fontWeight: 900, fontSize: '1.1rem' }}>{s.v}</div>
                        <div style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.65rem', fontWeight: 600, textTransform: 'uppercase' }}>{s.l}</div>
                     </div>
                   ))}
                </div>
              </div>

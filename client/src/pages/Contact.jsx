...
export default function Contact() {
  ...
  if (loading) return (
    <main className="container page" style={{ minHeight: '80vh', padding: '40px 16px' }}>
      <style>{`
        .contact-skeleton-shimmer {
          animation: contactShimmerSweep 1.6s infinite linear;
          background: linear-gradient(to right, #f6f7f8 8%, #edeef1 18%, #f6f7f8 33%);
          background-size: 1000px 104px;
          position: relative;
          overflow: hidden;
        }
        @keyframes contactShimmerSweep {
        ...
        @media (min-width: 768px) {
          .sk-contact-grid { grid-template-columns: 1.1fr 0.9fr; }
        }
        
        .sk-contact-title {
          width: 220px; height: 36px; border-radius: 6px; margin-bottom: 8px;
        }
        .sk-contact-desc {
          width: 80%; height: 16px; border-radius: 4px; margin-bottom: 32px;
        }
        ...
        .sk-form-btn {
          width: 100%; height: 48px; border-radius: 12px; margin-top: 8px;
        }
      ...
      <div className="sk-contact-title contact-skeleton-shimmer" />
      <div className="sk-contact-desc contact-skeleton-shimmer" />
      
      <div className="sk-contact-grid">
        {/* Left Side: Form Skeleton */}
        <div>
          <div className="sk-form-group">
            <div className="sk-form-label contact-skeleton-shimmer" />
            <div className="sk-form-input contact-skeleton-shimmer" />
          </div>
          <div className="sk-form-group">
            <div className="sk-form-label contact-skeleton-shimmer" />
            <div className="sk-form-input contact-skeleton-shimmer" />
          ...
          <div className="sk-form-group">
            <div className="sk-form-label contact-skeleton-shimmer" />
            <div className="sk-form-textarea contact-skeleton-shimmer" />
          </div>
          <div className="sk-form-btn contact-skeleton-shimmer" />
        </div>
        
        {/* Right Side: Info Cards Skeleton */}
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <div className="sk-info-card contact-skeleton-shimmer" />
          <div className="sk-info-card contact-skeleton-shimmer" />
          <div className="sk-info-card contact-skeleton-shimmer" />
        </div>
      </div>
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | NIRAA Wellness & Lifestyle</title>
        <meta name="description" content="Get in touch with Niraa Care. Reach us via phone, WhatsApp support, or visit us near the Old Bus Stand in Dharmapuri. We are here to help you." />
      </Helmet>
